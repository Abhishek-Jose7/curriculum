...
export const sampleCourse: CourseDraft = {
  ...
  teaching: { lecture_hours: 3, tutorial_hours: 1, practical_hours: 0, credits: 4 },
  examination: { internal_marks: 40, external_marks: 60, duration_hours: 3, passing_marks: 40 },
  outcomes: [
