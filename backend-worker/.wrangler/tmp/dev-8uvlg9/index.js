...
// .wrangler/tmp/bundle-WSw7Ii/checked-fetch.js
...
// .wrangler/tmp/bundle-WSw7Ii/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-WSw7Ii/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var BaseRepository = class {
  ...
  async create(data) {
    ...
    const values = columns.map((column) => normalizeValue2(payload[column]));
